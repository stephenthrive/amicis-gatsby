        ...
        <div className="w-full md:w-1/2">
          ...
          <div className="flex flex-wrap items-end ">
            <div className="w-full flex md:w-1/2 mb-8 md:mb-16">
              <a href="https://twitter.com/AmicisGroup" target="_blank" rel="noreferrer"><svg className="mr-4 w-8 md:w-16" xmlns="http://www.w3.org/2000/svg" width="49.535" height="40.258" viewBox="0 0 49.535 40.258">
              ...
              <a href="https://www.linkedin.com/company/amicis-group-limited/" target="_blank" rel="noreferrer"><svg className="w-8 md:w-16" xmlns="http://www.w3.org/2000/svg" width="40.393" height="40.361" viewBox="0 0 40.393 40.361">
