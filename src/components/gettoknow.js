    ...
    <section id="gettoknow" className="bg-darkblue text-white">
      ...
      <div className="custom-container flex">
        <div className="flex flex-wrap mb-8 md:mb-16 lg:mb-24 justify-center md:-mx-3">
          <div className="custom-cols mb-6 bg-white rounded-md md:mx-3 shadowXl">
              ...
              <div className="relative px-4 py-6">
                ...
                <div className="lg:mx-1/12">
                  <div className="pb-4">
                    ...
                    magna aliquam erat volutpat. #CyberSecurity
                  </div>
                  <div>Read more…</div>
                </div>
              </div>
          ...
          <div className="custom-cols mb-6 bg-white rounded-md md:mx-3">
            <div className="text-darkblue">
              ...
              <div className="relative px-4 py-6">
                ...
                <div className="lg:mx-1/12">
                  <div className="pb-4">Lorem ipsum dolor sit amet</div>
                  <div>Read more…</div>
                </div>
              </div>
            </div>
