  ...
  return (
      <section className="bg-lightgray">
      	<ul className="custom-container py-2 flex justify-center sm:justify-end">
	      	<li className="leading-none"><a href="tel:+441234567890" className="uppercase font-light tracking-widest text-darkblue hover:text-pink text-xs sm:text-sm border-b border-lightgray hover:border-darkblue">01234567890</a></li>
